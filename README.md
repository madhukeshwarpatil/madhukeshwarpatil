# Madhukeshwargouda Patil

Cloud & Platform Engineer · DevOps · SRE — Berlin, Germany

[Email](mailto:madhukeshwarpatil@gmail.com) · [LinkedIn](https://linkedin.com/in/madhukeshwargouda-patil-691a123b3)
...
**Software Engineer, Full-Stack** — Indust Logistik Technologies ·
Jul 2016 – Aug 2021
Built and shipped SaaS products end-to-end in .NET MVC, C#, and SQL Server.

## Stack

`AWS` `Terraform` `Docker` `GitHub Actions` `Jenkins` `Kafka` `Grafana`
`New Relic` `VictoriaMetrics` `PagerDuty` `Python` `Kotlin` `Scala`
`SQL Server` `TiDB`

## Education

- MSc Data Science, AI & Digital Business — GISMA University of Applied Sciences, Berlin (2026–2027, in progress)
- B.E. Electronics & Communication Engineering — Hubli, India (2012–2016)

## Languages

English (full professional) · Kannada (native) · Hindi (professional working) · German (beginner)
